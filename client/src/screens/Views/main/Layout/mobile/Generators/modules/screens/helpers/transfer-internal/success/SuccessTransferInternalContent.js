...
const SuccessTransferInternalContent = () => {
  ...
  const nameCreditTransfer = useAppSelector(state => state.transferInternal.NameOfSTKBankChoosingInternal)
  const cardCreditTransfer = useAppSelector(state => state.transferInternal.STKBankChoosingInternal)
  const messageCardTransfer = useAppSelector(state => state.transferInternal.messageTransferInternal)
  const timeTransferCard = useAppSelector(state => state.transferInternal.timeTransferBankInternal)
  const valueMoneyCardTransfer = useAppSelector(state => state.transferInternal.BankValueMoneyInternal)
...
export default SuccessTransferInternalContent;
